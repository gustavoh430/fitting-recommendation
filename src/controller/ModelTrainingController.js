export class ModelController {
    ...
    setupCallbacks() {
        ...
        this.#events.onTFVisLogs((logs) => {
            this.#modelView.updateEpochProgress(logs);
        });
    }


    async handleTrainModel() {
        // Enviaremos null ou undefined para que o próprio worker baixe os dados completos (users_grouped.json)
        this.#events.dispatchTrainModel(null);
    }
